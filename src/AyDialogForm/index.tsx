...
export default forwardRef(function AyDialogForm(
  props: AyDialogFormProps,
  ref?: Ref<AydialogFormRef>,
) {
  const {
    fields,
    title,
  ...
  /** form 需要的 fields */
  let [formFields, setFormFields] = useState<Array<AyFormField>>(
    getAyFormFields(fields, mode, initParams, dialogOnly),
  );
  /** form 控制 (需要主动调用里面的事件) */
